...
template <typename TImg> void WriteImage(const TImg *ptr, const std::string &path) {
...
template void
WriteScaledImage<VolumeF>(const VolumeF *img, const VolumeF *simg, const std::string &path);
