...
template auto ReadImage<VolumeF>(const std::string &path, const bool verbose) ->
    typename VolumeF::Pointer;
template auto ReadImage<VolumeD>(const std::string &path, const bool verbose) ->
    typename VolumeD::Pointer;
template auto ReadImage<VolumeXF>(const std::string &path, const bool verbose) ->
    typename VolumeXF::Pointer;
template auto ReadImage<VolumeXD>(const std::string &path, const bool verbose) ->
    typename VolumeXD::Pointer;
template auto ReadImage<VolumeI>(const std::string &path, const bool verbose) ->
    typename VolumeI::Pointer;
template auto ReadImage<VolumeUC>(const std::string &path, const bool verbose) ->
    typename VolumeUC::Pointer;
template auto ReadImage<SeriesF>(const std::string &path, const bool verbose) ->
    typename SeriesF::Pointer;
template auto ReadImage<SeriesD>(const std::string &path, const bool verbose) ->
    typename SeriesD::Pointer;
template auto ReadImage<SeriesXF>(const std::string &path, const bool verbose) ->
    typename SeriesXF::Pointer;
template auto ReadImage<SeriesXD>(const std::string &path, const bool verbose) ->
    typename SeriesXD::Pointer;
template auto ReadMagnitudeImage<VolumeF>(const std::string &path, const bool verbose) ->
    typename VolumeF::Pointer;
template auto ReadMagnitudeImage<SeriesF>(const std::string &path, const bool verbose) ->
    typename SeriesF::Pointer;
