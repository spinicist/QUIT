...
SIZE="32, 32, 32"
$QUITDIR/qinewimage --size "$SIZE" --step="2 0 1 2" mask.nii
...
$QUITDIR/qipolyfit baseline.nii --order=2 --print-terms --robust > robust_terms.txt
...
$QUITDIR/qipolyimg mask.nii robust.nii --order=2 < robust_terms.txt
compare_test "UNMASKED" baseline.nii unmasked.nii 1 1
compare_test "MASKED"   baseline.nii masked.nii   1 1
compare_test "ROBUST"   baseline.nii unmasked.nii 1 1
cd ..
SILENCE_TESTS="0"
