...
run_test "CREATE_SIGNALS" $QUITDIR/qisignal -T1 --3 -n -v << END_MCSIG
PD.nii
T1_m.nii
T2_m.nii
T1_ie.nii
...
PREFIX="$1"
OPTS="$2"
run_test $PREFIX $QUITDIR/qimcdespot $OPTS -n -v --3 -bB1.nii -r -o $PREFIX << END_INPUT
SPGR
$SPGR_FILE
$SPGR_FLIP
$SPGR_TR
...
PREFIX="$1"
OPTS="$2"
run_test $PREFIX $QUITDIR/qimcdespot $OPTS -T1 --finite -n -v --3 -bB1.nii -r -o $PREFIX << END_INPUT
SPGR
F$SPGR_FILE
$SPGR_FLIP
$SPGR_TR
