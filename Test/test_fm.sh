...
run_test "AMF"   $QUITDIR/qidespot2fm -n -v -bB1.nii T1.nii -T1 ${PREFIX}xf${SSFP_FILE} --finite -x -aa -o${PREFIX}xf  < ${PREFIX}fm_f_in.txt
...
compare_test "AMF"   T2.nii ${PREFIX}xfFM_T2.nii  0.01
